...
public abstract class Starter extends Character {
    ...
    public abstract boolean isAbleToUseBlowPipe(Starter starterEnemigo);
    
    public abstract boolean isAbleToHide(Starter starterEnemigo);
    
    public abstract boolean isAbleToReadTheFinalChapter(Starter starterEnemigo);
